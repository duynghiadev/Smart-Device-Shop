        ...
        {current && (
          <Fragment>
            <div
              ...
              className="flex items-center cursor-pointer justify-center gap-2 px-6 border-r"
            >
            ...
            >
              ...
              {isShowOption && (
                <div
                  ...
                  className="rounded-md flex-col flex py-2 absolute top-full left-[16px] bg-gray-100 border min-w-[150px] text-center"
                >
                  <Link
